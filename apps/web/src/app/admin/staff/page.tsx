        ...
        <div className="mt-4 grid gap-4 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-2 flex flex-wrap gap-2">
              ...
              <Link className={secondaryButton} href={`/admin/audit?actorId=${member.id}`}>{t("سجل نشاطه", "Activity log")}</Link>
            </div>
            {tempPassword && (
    ...
    <AdminShell user={user}>
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          {user.permissions.includes("role.manage") && <Link href="/admin/staff/roles" className={secondaryButton}>{t("مصفوفة الصلاحيات", "Permissions matrix")}</Link>}
